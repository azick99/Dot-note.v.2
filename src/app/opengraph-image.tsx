      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            ...
            >
              Chat with your{" "}
              <span style={{ color: "hsl(221.2, 83.2%, 53.3%)" }}>
                documents
              </span>
              <br />
              in seconds.
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px", marginTop: "4px" }}>
            ...
            >
              <div style={{ height: "8px", width: "120px", background: "rgba(255,255,255,0.6)", borderRadius: "4px" }} />
              <div style={{ height: "8px", width: "80px", background: "rgba(255,255,255,0.4)", borderRadius: "4px" }} />
            </div>
            <div
              style={{
                background: "#e2e8f0",
            ...
            >
              <div style={{ height: "8px", width: "100px", background: "#cbd5e1", borderRadius: "4px" }} />
            </div>
          </div>
        </div>
      </div>
